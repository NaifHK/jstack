...
import { DiscordMassage } from "@/components/discord-message"
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative lg:row-span-2">
              {/* inset make distance between an element and the parent element
                  and this will cover the entire parent element 
               */}
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  {/* here rounded-t-[12cqw] is to make border-radius shrink and grow with the parent element and
                   it's work with [container-type:inline-size] to */}
                  <div
                    className="absolute inset-x-10 bottom-0 top-10 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw]
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] ">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    ...
                    email, a purchase amount or an exceed quota.
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                  <Image
                    src="/bento-custom-data.png"
                    alt="bento box with custom data"
                    className="w-full max-lg:max-w-xs"
                    width={500}
                    height={300}
                  />
            ...
            <div className="relative lg:row-span-2">
              ...
              >
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    ...
                    call our intuitive API from any language.
                  </p>
                </div>
                  ...
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl">
                    <div className="flex bg-gray-800/40 ring-1 ring-white/5">
                      <div className="-mb-px flex text-sm/6 font-medium text-gray-400">
                        {/* file code */}
                        <div className="border-b border-r border-b-white/60 border-r-white/10 bg-white/5 px-4 py-2 text-white">
                          pingpang.js
                        </div>
                      </div>
                    </div>
              ...
              <div className="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-black/5 max-lg:rounded-r-[2rem] lg:rounded-b-[2rem]" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
